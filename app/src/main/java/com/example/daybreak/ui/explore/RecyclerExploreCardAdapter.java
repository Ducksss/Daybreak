...
public class RecyclerExploreCardAdapter extends RecyclerView.Adapter<RecyclerExploreCardAdapter.MyViewHolder> {
    private ArrayList<RecyclerExploreCardItem> exploreCardItems;
    private MyRecyclerViewItemClickListener mItemClickListener;

    public RecyclerExploreCardAdapter(ArrayList<RecyclerExploreCardItem> countries, MyRecyclerViewItemClickListener itemClickListener) {
